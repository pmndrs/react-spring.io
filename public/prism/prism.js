                ...
                for (var b = r, k = l; b < t.length; k += t[b].length, ++b) {
                  ...
                  if (!(w instanceof s)) {
                    if (m && b != t.length - 1) {
                      ...
                      if (!_) break
                      for (
                        var j = _.index + (d ? _[1].length : 0), P = _.index + _[0].length, A = b, O = k, x = t.length;
...
;(Prism.languages.javascript = Prism.languages.extend('clike', {
  ...
  Prism.languages.insertBefore('javascript', 'keyword', {
    ...
    parameter: [
      {pattern: /(function(?:\s+[_$a-z\xA0-\uFFFF][$\w\xA0-\uFFFF]*)?\s*\(\s*)[^\s()][^()]*?(?=\s*\))/, lookbehind: !0, inside: Prism.languages.javascript},
  ...
  Prism.languages.insertBefore('javascript', 'string', {
    'template-string': {
      ...
      greedy: !0,
      inside: {
        interpolation: {pattern: /\${[^}]+}/, inside: {'interpolation-punctuation': {pattern: /^\${|}$/, alias: 'punctuation'}, rest: Prism.languages.javascript}},
        string: /[\s\S]+/
      }
    }
  }),
  Prism.languages.markup &&
    Prism.languages.insertBefore('markup', 'tag', {
      script: {pattern: /(<script[\s\S]*?>)[\s\S]*?(?=<\/script>)/i, lookbehind: !0, inside: Prism.languages.javascript, alias: 'language-javascript', greedy: !0}
    }),
          ...
          ('string' != typeof i &&
            ('tag' === i.type && i.content[0] && 'tag' === i.content[0].type
              ? '</' === i.content[0].content[0].content
                ...
                : '/>' === i.content[i.content.length - 1].content || s.push({tagName: e(i.content[0].content[1]), openedBraces: 0})
              : s.length > 0 && 'punctuation' === i.type && '{' === i.content
              ? s[s.length - 1].openedBraces++
              : s.length > 0 && s[s.length - 1].openedBraces > 0 && 'punctuation' === i.type && '}' === i.content
              ? s[s.length - 1].openedBraces--
              : (o = !0)),
